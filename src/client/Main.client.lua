...
local debugPanel = U.frame(root, "StudioTools", 850, 430, 214, 208, C.Colors.Panel)
...
U.button(debugPanel, "DevCoins", "+250K COINS", 10, 134, 194, 29, function()
	send("debugCoins")
end, C.Colors.Mint)
U.button(debugPanel, "FillRanch", "FILL RANCH • 8 PETS", 10, 169, 194, 29, function()
	send("debugRanch")
end, C.Colors.Gold)
