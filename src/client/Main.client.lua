...
local ranchDiagnostics = require(script.Parent.RanchClientChecks).bind(effects)
...
U.button(debugPanel, "NightToggle", "TOGGLE NIGHT", 10, 64, 198, 29, function()
	send("debugNight")
end, C.Colors.Blue)
U.button(debugPanel, "TestItems", "ADD TEST ITEMS", 10, 99, 198, 29, function()
	send("debugItems")
end, C.Colors.Gold)
U.button(debugPanel, "DevCoins", "+250K COINS", 10, 134, 198, 29, function()
	send("debugCoins")
end, C.Colors.Mint)
U.button(debugPanel, "FillRanch", "FILL CURRENT RANCH", 10, 169, 198, 29, function()
	send("debugRanch")
end, C.Colors.Gold)
