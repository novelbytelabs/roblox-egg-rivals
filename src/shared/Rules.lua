...
function R.validate()
	...
	assert(R.integer(C.PrecisionUnlockTier, 2, #C.Grades))
	assert(R.finite(C.PrecisionFactor) and C.PrecisionFactor > 0 and C.PrecisionFactor < 1)
	assert(R.integer(C.OverdriveCutUnlockTier, C.PrecisionUnlockTier, #C.Grades))
	assert(R.finite(C.VisitorInspectRange) and C.VisitorInspectRange >= 8 and C.VisitorInspectRange <= 24)
	assert(R.finite(C.VisitorReactionCooldown) and C.VisitorReactionCooldown >= 1 and C.VisitorReactionCooldown <= 10)
